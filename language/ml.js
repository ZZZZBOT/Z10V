...
exports.wrongFormat = () => {
	return `❎ ഫോർമാറ്റ് തെറ്റാണ്, മെനുവിൽ വീണ്ടും പരിശോധിക്കാൻ ശ്രമിക്കുക`
	}
exports.erorStik = () => {
	return `❎ അതൊരു സ്റ്റിക്കറല്ല`
	}
exports.tagStik = () => {
	return `❎ സ്റ്റിക്കർ മറുപടി/ടാഗ് ചെയ്യുക`
	}
exports.erorLink = () => {
	return `❎ അസാധുവായ ലിങ്ക്`
	}
exports.onlygc = () => {
	return `❎ ഈ സവിശേഷത ഗ്രൂപ്പ് മാത്രമാണ്`
	}
exports.onlyOwner = () => {
	return `❎ പ്രത്യേക ഉടമ ബോട്ട്`
	}
exports.benned = () => {
	return `❎ ക്ഷമിക്കണം, നിങ്ങളുടെ നമ്പർ തടഞ്ഞു`
	}
exports.onlygcAdmin = () => {
	return `❎ ഗ്രൂപ്പ് അഡ്മിൻ മാത്രം`
	}
exports.cariCecan = () => {
...
exports.pesanBot = () => {
	return `❎ ബോട്ട് സന്ദേശത്തിന് മറുപടി നൽകുക`
	}
exports.replyFoto = () => {
	return `❎ ഫോട്ടോയ്ക്ക് മറുപടി നൽകുക`
	}
exports.tagUser = () => {
	return `❎ Tag @user`
	}
exports.noReply = () => {
	return `❎ നിങ്ങൾ മറുപടി നൽകിയ സന്ദേശത്തിൽ ഒരു മറുപടി അടങ്ങിയിട്ടില്ല`
	}
exports.changeNmGc = () => {
...
exports.spam = (prefix, command) => {
	return `❎ ഉദാഹരണം ${prefix + command} ടെക്സ്റ്റ്|തുക`
	}
exports.tahta = (prefix, command) => {
	return `❎ ഉദാഹരണം ${prefix + command} zeeone|ofc`
	}
exports.noteks = (prefix, command) => {
	return `❎ ഉദാഹരണം ${prefix + command} zeeone`
	}
exports.botNotAdm = () => {
	return `ഈ കമാൻഡ് ഉപയോഗിക്കാൻ ബോട്ട് അഡ്മിനെ ഉണ്ടാക്കുക`
	}
exports.tryAgain = () => {
	return `❎  പരാജയപ്പെട്ടു, വീണ്ടും ശ്രമിക്കുക ^_^`
	}
exports.anlinOn = () => {
